	...
	<div id="home">
			...
			<div class="container">
				<div class="header d-lg-flex justify-content-between align-items-center">
					...
					<h1 class="logo text-center">
						<a href="index.php">Plants<i class="fa fa-pagelines" aria-hidden="true"></i>
						</a>
					</h1>
					<!-- //logo -->
					<!-- nav -->
		...
		<div class="banner_w3lspvt">
			<div class="csslider infinity" id="slider1">
				...
				<ul>
					<li>
						<div class="banner-topv">
							<div class="container">
								<div class="w3layouts-banner-info text-center">
									<h3 class="text-wh">GREENS WORTH</h3>
				...
				<div class="col-lg-4 address-grid">
					<div class="row address-info">
						...
						<div class="col-md-9 col-8 address-right">
							<p>
								<a href="mailto:example@email.com"> appanaprasadsiva@gmail.com</a>
							</p>
							<p>
								<a href="mailto:example@email.com"> prakashgolla8@gmail.com</a>
							</p>
						</div>
					</div>
				</div>
